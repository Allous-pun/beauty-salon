...
<html lang="en">
  <head>
    ...
    <title>Smart Beauty Advisor | Booking History</title>
...
<section class="w3l-inner-banner-main">
 ...
 Booking History
            ...
            <p class="tiltle-para ">Our booking history provides a detailed record of all past appointments, including services availed, dates, times, assigned beauticians, and payment details. It ensures transparency and convenience, allowing clients to review their past visits, track completed or canceled bookings, and plan future appointments with ease.</p>
        </div>
</div>
</div>
